...
function Testimonial(){
  ...
  <img src="/assets/images/backgrounds/map.png" alt="map" class="img-fluid bg-map"></img>
  <img src="/assets/images/illustrations/dots-group-v.png" alt="bg-shape" class="img-fluid bg-shape-1"></img>
  <img src="/assets/images/illustrations/leaf-orange.png" alt="bg-shape" class="img-fluid bg-shape-2"></img>
  <img src="/assets/images/illustrations/dots-group-sm.png" alt="bg-shape" class="img-fluid bg-shape-3"></img>
  <img src="/assets/images/illustrations/leaf-pink-round.png" alt="bg-shape" class="img-fluid bg-shape-4"></img>
  <img src="/assets/images/illustrations/leaf-cyan.png" alt="bg-shape" class="img-fluid bg-shape-5"></img>
</section>
    )
